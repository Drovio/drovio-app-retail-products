...
foreach ($allPrices as $priceInfo)
{
	...
	$fRow = getSelectFormRow($form, $typeResource = $priceTypes, $typeValue = $priceInfo['type_id'], $valueValue = $priceInfo['price'], $class = "", $ph, $name = "price", $id = $priceInfo['type_id'], $removable = TRUE, $attr);
	DOM::append($group, $fRow);
}
