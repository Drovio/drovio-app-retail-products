...
// Stock info section
$section = DOM::create("div", "", "", "section stock_info");
DOM::append($detailsContainer, $section);

// Load view
$attr = array();
$attr['pid'] = $productID;
$viewContainer = $appContent->getAppViewContainer($viewName = "stock/stockInfo", $attr, $startup = FALSE, $containerID = "stockInfoViewContainer", $loading = FALSE, $preload = TRUE);
DOM::append($section, $viewContainer);
